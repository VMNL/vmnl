...
| `window_events_input` | `just run window_events_input` | window builder/config, polling, events, monitors, input, cursor resources/modes/raw motion, timers, lifecycle |
