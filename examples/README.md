...
| `d2_advanced_geometry` | `just run d2_advanced_geometry` | indices, vertex colors, transforms, line caps, polyline joins/caps/color modes, memory preferences, render modes |
