...
impl ArcBuilder {
    ...
    fn validate_parameters(
        ...
        validate_finite(&[position.x, position.y], "arc position")?;
        validate_positive_finite(&[radius], "arc radius")?;
        validate_finite(&[start_angle], "arc start angle")?;
        validate_finite(&[sweep], "arc sweep")?;
        validate_positive_finite(&[width], "arc width")?;
        validate_positive_finite(&[segment_count.into()], "arc segment count")?;
        ...
        validate_positive_finite(&[inner_radius], "arc inner radius")?;
        ...
        validate_finite(&[outer_radius], "arc outer radius")?;
...
mod tests {
    ...
    #[test]
    fn validate_parameters_accepts_valid_arc() {
        assert!(ArcBuilder::validate_parameters(
    ...
    #[test]
    fn validate_parameters_rejects_invalid_radius() {
        assert_invalid_state(
            ArcBuilder::validate_parameters(
        ...
        assert_invalid_state(
            ArcBuilder::validate_parameters(Vector2f { x: 0.0, y: 0.0 }, 0.0, 30.0, 140.0, 8.0, 16),
    ...
    #[test]
    fn validate_parameters_rejects_invalid_angles() {
        assert_invalid_state(
            ArcBuilder::validate_parameters(
                Vector2f { x: 0.0, y: 0.0 },
                80.0,
    ...
    #[test]
    fn validate_parameters_rejects_invalid_width() {
        assert_invalid_state(
            ArcBuilder::validate_parameters(
                Vector2f { x: 0.0, y: 0.0 },
                80.0,
    ...
    #[test]
    fn validate_parameters_rejects_invalid_segments() {
        assert_invalid_state(
            ArcBuilder::validate_parameters(Vector2f { x: 0.0, y: 0.0 }, 80.0, 30.0, 140.0, 8.0, 0),
            "arc segment count must be strictly positive",
        );
    }

    #[test]
    fn validate_parameters_rejects_invalid_position() {
        assert_invalid_state(
            ArcBuilder::validate_parameters(
                Vector2f {
                    x: f32::NAN,
    ...
    fn geometry_creates_open_stroked_arc() {
        ...
        let start_angle = (30.0_f32 - 90.0).to_radians();
