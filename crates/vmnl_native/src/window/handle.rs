...
impl VMNLWindow
{
    ...
    {
        self.window_handle.context.set_framebuffer_size_polling(enabled);
    }
    ...
    {
        self.window_handle.context.set_drag_and_drop_polling(enabled);
    }
    ...
    {
        self.window_handle.context.set_content_scale_polling(enabled);
    }
    ...
    pub(crate) fn enable_window_state_polling(&mut self)
    {
        ...
        self.window_handle.context.set_framebuffer_size_polling(true);
    ...
    pub(crate) fn disable_window_state_polling(&mut self)
    {
        ...
        self.window_handle.context.set_framebuffer_size_polling(false);
