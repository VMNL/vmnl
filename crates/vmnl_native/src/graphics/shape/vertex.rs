...
////////////////////////////////////////////////////////////////////////////////
use super::{Shape, ShapeKind::RawVertices, VMNLVertex};
use crate::{graphics::GraphicsResourceFactory, Context, VMNLResult, VMNLrbg};
...
impl Shape {
    ...
    /// };
    /// let triangle = Shape::create_triangle(&vmnl_context, vertex1, vertex2, vertex3);
