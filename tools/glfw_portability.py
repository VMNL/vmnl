...
RUST_CALL_TO_C = {
    ...
    ".has_sticky_mouse_buttons(": "glfwGetInputMode",
    ".does_store_lock_key_mods(": "glfwGetInputMode",
    ".set_sticky_mouse_buttons(": "glfwSetInputMode",
    ".set_store_lock_key_mods(": "glfwSetInputMode",
